...
const I = {
  ...
  request: () => <svg viewBox="0 0 24 24" className="h-5 w-5"><path fill="currentColor" d="M19 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2zM8.5 16.5l-4.5-4.5L6.91 10l1.59 1.59L16.59 4l1.91 1.91z"/></svg>,
...
const ROLE_MENUS: Record<Role, Item[]> = {
  ...
  "ban-chu-nhiem": [
    ...
    { path: "/request", label: "Quản lý yêu cầu", icon: <I.request /> },
