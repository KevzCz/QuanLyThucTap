  ...
  return (
    <div className="space-y-4">
      ...
      {(title || onSearchChange || filters || statusPill || primaryAction || secondaryActions) && (
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-white rounded-xl sm:rounded-2xl border border-gray-200 shadow-sm flex-wrap">
          {title && !breadcrumb && (
            <h1 className="text-base sm:text-lg font-semibold text-gray-900 w-full sm:w-auto">{title}</h1>
          )}
          ...
          {statusPill && (
            <span className={`inline-flex items-center gap-2 rounded-full border px-3 h-9 text-xs sm:text-sm w-full sm:w-auto justify-center ${
          ...
          {secondaryActions?.map((action, index) => (
            <button
              ...
              className={`inline-flex items-center justify-center gap-2 rounded-md px-3 h-9 text-xs sm:text-sm font-medium transition-colors touch-manipulation w-full sm:w-auto ${
          ...
          {primaryAction && (
            <button
              ...
              className={`inline-flex items-center justify-center gap-2 rounded-md px-3 h-9 text-xs sm:text-sm font-medium transition-colors touch-manipulation w-full sm:w-auto sm:ml-auto ${
