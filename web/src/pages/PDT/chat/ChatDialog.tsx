...
const MOCK_MESSAGES: ChatMessage[] = [
  {
    id: "msg1",
    senderId: "BCN002",
    content: "Xin chào, tôi cần hỗ trợ về quy trình phê duyệt môn thực tập mới.",
  ...
  },
  {
    id: "msg2",
    senderId: "PDT001",
    content: "Chào bạn! Tôi sẽ hỗ trợ bạn về vấn đề này. Bạn có thể mô tả chi tiết hơn về môn thực tập cần phê duyệt không?",
  ...
  },
  {
    id: "msg3",
    senderId: "BCN002",
    content: "Môn thực tập này dành cho sinh viên năm cuối, tập trung vào phát triển ứng dụng AI. Chúng tôi cần thêm vào chương trình học kỳ tới.",
  ...
  },
  {
    id: "msg4",
    senderId: "PDT001",
    content: "Được rồi, bạn cần chuẩn bị các tài liệu sau và gửi qua hệ thống:",
  ...
  },
  {
    id: "msg5",
    senderId: "PDT001",
    content: "1. Đề cương chi tiết môn học\n2. Danh sách giảng viên phụ trách\n3. Kế hoạch triển khai\n4. Đánh giá tài nguyên cần thiết",
    timestamp: "2025-01-20T14:38:00",
    type: "text",
  },
];
