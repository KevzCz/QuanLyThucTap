...
const ViewKhoaReportDialog: React.FC<Props> = ({ open, onClose, report }) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <div className="text-sm text-blue-600 mt-1">
                <span className="font-medium">Mã GV:</span> {report.instructor.id}
              </div>
            </div>
            <div>
              <div className="text-sm text-blue-800">
        ...
        {report.reviewedBy && (
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
            <div className="text-sm text-gray-700">
              <span className="font-medium">Được xem xét bởi:</span> {report.reviewedBy.name} ({report.reviewedBy.id})
            </div>
          </div>
        )}
...
export default ViewKhoaReportDialog;
