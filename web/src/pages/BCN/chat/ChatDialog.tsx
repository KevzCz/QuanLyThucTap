...
// Mock messages for BCN conversation
const MOCK_MESSAGES: ChatMessage[] = [
  {
    id: "msg1",
    senderId: "GV002",
    content: "Chào anh, em cần hỗ trợ về việc quản lý danh sách sinh viên thực tập.",
  ...
  },
  {
    id: "msg2",
    senderId: "BCN001",
    content: "Chào em! Anh sẽ hỗ trợ em về vấn đề này. Em có thể mô tả cụ thể hơn về vấn đề gặp phải không?",
  ...
  },
  {
    id: "msg3",
    senderId: "GV002",
    content: "Em đang gặp khó khăn trong việc phân bổ sinh viên cho các công ty thực tập. Một số sinh viên chưa có nơi thực tập phù hợp.",
  ...
  },
  {
    id: "msg4",
    senderId: "BCN001",
    content: "Anh hiểu rồi. Anh sẽ liên hệ với các doanh nghiệp đối tác để tìm thêm chỗ thực tập. Em có danh sách sinh viên cần hỗ trợ không?",
