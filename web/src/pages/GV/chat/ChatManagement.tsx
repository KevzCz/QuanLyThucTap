...
const ChatManagement: React.FC = () => {
  ...
  }, [user, transformApiRequestToLocal, transformApiConversationToLocal, loadConversations]);
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-start sm:items-center justify-between">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 w-full sm:w-auto">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm whitespace-nowrap touch-manipulation"
          >
            <svg viewBox="0 0 24 24" className="h-4 w-4">
