    ...
    <Modal
      ...
      title={
        <div className="flex items-center justify-between w-full">
          ...
          {isConversationActive && currentUser.role === 'giang-vien' && (
          ...
          <div className="border-t border-gray-200 p-3 sm:p-4">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="p-2.5 sm:p-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors touch-manipulation"
                title="Đính kèm file (Ctrl+V để dán)"
              >
                <svg viewBox="0 0 24 24" className="h-5 w-5 sm:h-5 sm:w-5">
