...
import type { SubHeader, Attachment } from "./KhoaPageViewTypes";
      ...
      <div className="rounded-2xl border border-gray-200 bg-white shadow-sm p-5">
        ...
        {sub?.attachments && sub.attachments.length > 0 && (
          <div className="mt-6 border-t pt-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">📎 File đính kèm</h3>
            <div className="space-y-2">
              {sub.attachments.map((attachment: Attachment, index: number) => (
                <a
                  key={index}
