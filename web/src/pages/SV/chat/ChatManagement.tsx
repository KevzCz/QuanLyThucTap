...
const MOCK_REQUESTS: ChatRequest[] = [
  {
    ...
    toUser: { id: "SV001", name: "Nguyễn Văn B", role: "sinh-vien", isOnline: true },
    message: "Cần hỗ trợ em về thủ tục đăng ký thực tập và các yêu cầu cần thiết.",
    timestamp: "2025-01-20T14:30:00",
    status: "pending",
  },
  {
    id: "req2",
    fromUser: { id: "BCN001", name: "PGS. Trần Văn C", role: "ban-chu-nhiem", isOnline: false },
    toUser: { id: "SV001", name: "Nguyễn Văn B", role: "sinh-vien", isOnline: true },
    message: "Em cần cập nhật thông tin về tiến độ thực tập hiện tại.",
    timestamp: "2025-01-20T13:15:00",
    status: "pending",
  },
  {
    id: "req3",
    fromUser: { id: "GV001", name: "ThS. Phạm Thị D", role: "giang-vien", isOnline: true },
    toUser: { id: "SV001", name: "Nguyễn Văn B", role: "sinh-vien", isOnline: true },
    message: "Em cần nộp báo cáo thực tập tuần này và báo cáo tiến độ công việc.",
...
const MOCK_CONVERSATIONS: ChatConversation[] = [
  {
    id: "conv1",
    participants: [
      { id: "SV001", name: "Nguyễn Văn B", role: "sinh-vien", isOnline: true },
      { id: "GV002", name: "TS. Hoàng Văn E", role: "giang-vien", isOnline: true },
    ],
    lastMessage: {
      id: "msg1",
      senderId: "GV002",
      content: "Em đã làm tốt báo cáo tuần này, tiếp tục duy trì.",
  ...
  },
  {
    ...
    participants: [
      { id: "SV001", name: "Nguyễn Văn B", role: "sinh-vien", isOnline: true },
      { id: "BCN002", name: "PGS. Võ Thị F", role: "ban-chu-nhiem", isOnline: false },
    ],
    lastMessage: {
      id: "msg2",
      senderId: "BCN002",
      content: "Thủ tục đã được xử lý, em theo dõi thông báo.",
...
const ChatManagement: React.FC = () => {
  ...
  const handleSendChatRequest = (request: ChatRequest) => {
    // In real app, this would send to server
    alert(`Yêu cầu chat đã được gửi đến ${request.toUser.name}`);
    setOpenCreateChatRequest(false);
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Nhận hỗ trợ từ giảng viên và ban chủ nhiệm</p>
          </div>
          <button
          ...
          <div className="divide-y divide-gray-100">
            {filteredRequests.length === 0 ? (
              <div className="p-8 text-center text-gray-500">
                ...
                <div className="text-sm">Các yêu cầu chat từ giảng viên sẽ hiển thị ở đây</div>
              </div>
            ) : (
      ...
      <ChatDialog
        ...
        currentUser={{ id: "SV001", name: "Nguyễn Văn B", role: "sinh-vien", isOnline: true }}
      />
    </div>
  );
};
